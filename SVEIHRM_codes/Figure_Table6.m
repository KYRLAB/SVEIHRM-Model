clear all
%%% Experiments according to vaccination rate
% figure
% for Rt=1.5:0.1:2.5
for Rt=1.8
vact=100;
...
% text(140,2773070,'\leftarrow 80.35%')
% text(139,2493160,'\leftarrow 71.76%')
% text(140,1602080,'\leftarrow 51.39%')
% legend('No vaccine','VD=300, VS=50','VD=200, VS=100')
legend('VD=300, VS=50','VD=100, VS=100')

title('Effect of Vaccine (No mutant)')
% xlabel('400 days, R_0=2') 
ylabel('The number of infectious people')
% limits=[0 6*10^4];
% ylim(limits)
xlabel(['R_0=',num2str(Rt)])
grid on
% save_name=sprintf('VS=%d_VD=%d_Rt=%.1f.eps',vact,tvac,Rt)
