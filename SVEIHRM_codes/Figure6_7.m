...
text(143,2508390,'\leftarrow 77.37%')
text(142,1839670,'\leftarrow 61.42%')
text(152,991630,'\leftarrow 41.85%')



title('Effectiveness of vaccines according to VS without mutant viruses')
xlabel('For 250 days when R_0=2.0') 
ylabel('The number of infectious people')
grid on
% xline(100,'r','LineWidth',2),xline(75,'y','LineWidth',2),xline(50,'p','LineWidth',2)
% limits=[0 6*10^6];
% ylim(limits)
% xlabel(['R_0=',num2str(Rt)])
legend('No vaccine','VS=100','VS=75','VS=50')
% save_name=sprintf('VS=%d_Rt=%.1f_Mm=%.1f.eps',vact,Rt,Mm)
