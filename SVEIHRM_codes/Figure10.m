...
% xlabel('600 days, R_0=1.4, \tau=1.6') 
% ylabel('The number of infectious people')
title('Daily infection with coronavirus or mutant virus according to VD')
xlabel('For 800 days with R_0=1.3 and \tau=1.8') 
ylabel('The number of infected individuals')
legend('VD=1/280','VD=1/300','VD=1/320')
